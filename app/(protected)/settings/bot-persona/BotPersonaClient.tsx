...
import { Bot, MessageCircle, Users, Smile, AlertTriangle, Hand } from "lucide-react";
...
interface PersonaData {
	...
	conversation_starter_message: string;
}
...
const agentConfigs: AgentConfig[] = [
	{
		key: "conversation_starter_message",
		name: "Chat Opening Message",
		description: "Initiates conversations with engaging opening lines",
...
export default function BotPersonaClient() {
		...
		<div className="space-y-3 flex flex-1 flex-col">
			...
			{showWarning && (
				<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
					<div className="bg-white rounded-xl p-3 max-w-md w-mx-4 shadow-xl">
