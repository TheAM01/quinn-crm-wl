...
export const ProductWaitlistsTab = ({ products, loading, onViewWaitlist }: ProductWaitlistsTabProps) => {
        ...
        <div>
            ...
            <div className="space-y-4">
                {products.map((product) => (
                    <div key={product.variant_id} className="border-2 border-neutral-300 rounded-lg p-4 hover:shadow-lg transition-shadow bg-white">
