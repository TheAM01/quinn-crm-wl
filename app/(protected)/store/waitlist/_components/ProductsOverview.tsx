        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-6">
                {products.map((product) => (
                    <div key={product.variant_id} className="border-2 border-neutral-200 rounded-lg p-4 hover:shadow-xl transition-shadow bg-white">
                        <div className="relative w-full h-70 mb-4 rounded-md overflow-hidden flex items-center">
                            <img
                        ...
                        <div className="space-y-2 text-sm">
                            ...
                            <div className="flex items-center justify-between bg-yellow-200 p-2 rounded-md">
                                <span className="text-neutral-800 text-base font-bold">Waitlist Count:</span>
                                <span className="font-bold text-base">{product.waitlist_count}</span>
                            </div>
                        </div>
                        <a
