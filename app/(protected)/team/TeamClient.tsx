...
export default function TeamUsers() {
	...
	if (loading) {
		return <PageLoader text={"Loading Team Management..."}/>
	}

	return (
		<div className="p-3 bg-gray-50 flex flex-1 flex-col">
			<div className="mb-6 flex justify-between items-center">
				...
				<SearchBar searchTerm={searchTerm} onSearchChange={setSearchTerm} resultsAmount={filteredUsers.length}/>
				<Link
					href="/team/add"
