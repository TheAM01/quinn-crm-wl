...
export default function DocumentUpload() {
	...
	if (loading) {
		return <PageLoader text={"Loading Knowledge Base..."}/>
	}
			...
			<div className="">
				...
				<div className="mb-8">
					<div className="flex items-center justify-between mb-6">
						<PageHeading title={"Documents"} description={"Manage your document library"} bottomMargin={"0"}/>
						<SearchBar searchTerm={searchTerm} onSearchChange={setSearchTerm} resultsAmount={filteredDocuments.length}/>
						<button
				...
				<div className="space-y-4">
					{filteredDocuments.length === 0 ? (
						...
						filteredDocuments.map((doc) => (
							<div key={doc.id} className="bg-white rounded-lg shadow-sm border border-neutral-200 p-6">
